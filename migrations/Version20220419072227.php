 ...
 */
final class Version20220419072227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, character_code VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, lesson_content TEXT NOT NULL, serial_number INT NOT NULL, PRIMARY KEY(id))');
